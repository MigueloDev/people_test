  ...
  return (
    <header>
      ...
      <a href="/" className="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span className="fs-4">Store Example</span>
      </a>

      <nav className="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <a className="me-3 py-2 text-dark text-decoration-none" href="#">Home</a>
        <a className="me-3 py-2 text-dark text-decoration-none" href="#">Cart</a>
        <a className="me-3 py-2 text-dark text-decoration-none" href="#">Wish List</a>
      </nav>
    </div>
    </header>
  )
